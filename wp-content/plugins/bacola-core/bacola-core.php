...
final class Bacola_Elementor_Addons
{
    ...
    */
    ...
    {
        load_plugin_textdomain( 'bacola-elementor' );
    }
    ...
    */
    ...
    {
        $elements_manager->add_category( 'bacola', ['title' => esc_html__( 'Bacola Core', 'bacola' )]);
    }	
    ...
    */
    public function bacola_admin_notice_missing_main_plugin()
    {
        ...
        $message = sprintf(
            ...
            esc_html__( '%1$s requires %2$s to be installed and activated.', 'bacola' ),
            '<strong>' . esc_html__( 'Bacola Core', 'bacola' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'bacola' ) . '</strong>'
        );
    ...
    */
    public function bacola_admin_notice_minimum_elementor_version()
    {
        ...
        $message = sprintf(
            ...
            esc_html__( '%1$s requires %2$s version %3$s or greater.', 'bacola' ),
            '<strong>' . esc_html__( 'Bacola Core', 'bacola' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'bacola' ) . '</strong>',
    ...
    */
    public function bacola_admin_notice_minimum_php_version()
    {
        ...
        $message = sprintf(
            ...
            esc_html__( '%1$s requires %2$s version %3$s or greater.', 'bacola' ),
            '<strong>' . esc_html__( 'Bacola Core', 'bacola' ) . '</strong>',
            '<strong>' . esc_html__( 'PHP', 'bacola' ) . '</strong>',
