...
class Bacola_Banner_Box3_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control( 'banner_type',
			[
				'label' => esc_html__( 'Banner Type', 'bacola' ),
        ...
        $this->add_control( 'desc',
            [
                'label' => esc_html__( 'Description', 'bacola' ),
                'type' => Controls_Manager::TEXT,
		...
		$this->add_control( 'Desc_color',
           [
               'label' => esc_html__( 'Description Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '#9b9bb4',
		...
		$this->add_control( 'desc_size',
            [
                'label' => esc_html__( 'Description Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
