...
class Bacola_Banner_Box4_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control( 'button_type',
			[
				'label' => esc_html__( 'Button Type', 'bacola' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'button-danger',
				'options' => [
					'select-type' => esc_html__( 'Select Type', 'bacola' ),
					'button-info-dark'	=> esc_html__( 'Type 1', 'bacola' ),
					'button-danger'	  	=> esc_html__( 'Type 2', 'bacola' ),
					'button-primary'	=> esc_html__( 'Type 3', 'bacola' ),
					'button-secondary'	=> esc_html__( 'Type 4', 'bacola' ),
				],
			]
		);
		...
		$this->add_responsive_control( 'banner_box4_padding',
            [
                'label' => esc_html__( 'Padding', 'bacola' ),
		...
		$this->add_responsive_control( 'banner_box4_height',
            [
                'label' => esc_html__( 'Height', 'bacola' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'vh' ],
                'range' => [
                    'px' => [
		...
		$this->add_control( 'title_color',
           [
               'label' => esc_html__( 'Title Color', 'bacola' ),
		...
		$this->add_group_control(
            ...
            [
                'name' => 'title_typo',
                'label' => esc_html__( 'Typography', 'bacola' ),
		...
		$this->add_control( 'subtitle_heading',
            [
                'label' => esc_html__( 'SUBTITLE', 'bacola' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
		...
		$this->add_control( 'subtitle_color',
           [
               'label' => esc_html__( 'Subtitle Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'subtitle_size',
            [
                'label' => esc_html__( 'Subtitle Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
		...
		$this->add_control( 'second_subtitle_heading',
            [
                'label' => esc_html__( 'SECOND SUBTITLE', 'bacola' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'second_subtitle_color',
           [
               'label' => esc_html__( 'Second Subtitle Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_subtitle_size',
            [
                'label' => esc_html__( 'Second Subtitle Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
		...
		$this->add_control( 'offer_bg',
           [
               'label' => esc_html__( 'Offer Background Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'offer_color',
           [
               'label' => esc_html__( 'Offer Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'offer_size',
            [
                'label' => esc_html__( 'Offer Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
		...
		$this->add_control( 'price_text_heading',
            [
                'label' => esc_html__( 'PRICE TEXT', 'bacola' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'price_text_color',
           [
               'label' => esc_html__( 'Price Text Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'price_text_size',
            [
                'label' => esc_html__( 'Price Text Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
		...
		$this->add_control( 'price_color',
           [
               'label' => esc_html__( 'Price Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'price_size',
            [
                'label' => esc_html__( 'Price Size', 'bacola' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->start_controls_section('btn_styling',
            [
                'label' => esc_html__( ' Button Style', 'bacola' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
	    ...
	    $this->add_group_control(
            ...
            [
                'name' => 'btn_border',
                'label' => esc_html__( 'Border', 'bacola' ),
		...
		$this->add_responsive_control( 'btn_border_radius',
            [
                'label' => esc_html__( 'Border Radius', 'bacola' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
		...
		$this->add_control( 'btn_bgclr',
           [
               'label' => esc_html__( 'Background Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
               'selectors' => [
