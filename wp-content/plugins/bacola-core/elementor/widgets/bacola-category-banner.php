...
class Bacola_Category_Banner_Widget extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control( 'post_count',
            [
                'label' => esc_html__( 'Posts Per Page', 'bacola' ),
        ...
        $this->add_control( 'cat_filter',
            [
                'label' => esc_html__( 'Filter Category', 'bacola' ),
        ...
        $this->add_control( 'post_include_filter',
            [
                'label' => esc_html__( 'Include Post', 'bacola' ),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
		...
		$this->add_control( 'on_sale',
			[
				'label' => esc_html__( 'On Sale Products?', 'bacola' ),
		...
		$this->add_control( 'featured',
			[
				'label' => esc_html__( 'Featured Products?', 'bacola' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'bacola' ),
				'label_off' => esc_html__( 'False', 'bacola' ),
				'return_value' => 'true',
		...
		$this->add_control( 'best_selling',
			[
				'label' => esc_html__( 'Best Selling Products?', 'bacola' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'bacola' ),
				'label_off' => esc_html__( 'False', 'bacola' ),
				'return_value' => 'true',
		...
		$this->start_controls_section(
			'banner_section',
			[
				'label' => esc_html__( 'Banner', 'bacola' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control( 'subtitle_hvrcolor',
           [
               'label' => esc_html__( 'Subtitle Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
        ...
        $this->start_controls_tab( 'btn_normal_tab',
            [ 'label' => esc_html__( 'Normal', 'bacola' ) ]
        );
		...
		$this->add_control( 'btn_hvrbgclr',
           [
               'label' => esc_html__( 'Background Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
               'selectors' => [
