	...
	protected function _register_controls() {
       ...
       $this->add_control( 'desc',
		...
		$this->add_responsive_control( 'icon_size',
            [
                'label' => esc_html__( 'Icon Size', 'bacola' ),
		...
		$this->add_control( 'icon_color',
           [
               'label' => esc_html__( 'Icon Color', 'bacola' ),
		...
		$this->add_control( 'icon_hvrcolor',
           [
               'label' => esc_html__( 'Icon Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'desc_hvrcolor',
           [
               'label' => esc_html__( 'Description Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
