	...
	protected function _register_controls() {
       ...
       $this->add_control( 'title',
		...
		$this->add_control( 'second_title_color',
           [
               'label' => esc_html__( 'Second Title Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'second_title_hvrcolor',
           [
               'label' => esc_html__( 'Second Title Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'date_heading',
            [
                'label' => esc_html__( 'DUA DATE', 'bacola' ),
                'type' => Controls_Manager::HEADING,
				'separator' => 'before'
            ]
        );
		...
		$this->add_control( 'date_bg_color',
           [
               'label' => esc_html__( 'Due Date Background Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'date_bg_hvrcolor',
           [
               'label' => esc_html__( 'Due Date Background Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'date_color',
           [
               'label' => esc_html__( 'Due Date Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'date_hvrcolor',
           [
               'label' => esc_html__( 'Due Date Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
