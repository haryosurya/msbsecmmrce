	...
	protected function _register_controls() {
        ...
        $this->add_control( 'title',
            [
                ...
                'placeholder' => esc_html__( 'Enter title here', 'bacola' )
            ]
        );
        ...
        $this->add_control( 'customer_name',
            [
				...
				'label_block' => true,
                'pleaceholder' => esc_html__( 'Enter the name here', 'bacola' ),
        ...
        $this->add_control( 'customer_position',
            [
                'label' => esc_html__( 'Position', 'bacola' ),
                'type' => Controls_Manager::TEXT,
				'label_block' => true,
                'pleaceholder' => esc_html__( 'Enter the customer job.', 'bacola' ),
        ...
        $this->add_control( 'customer_comment_title',
            [
                'label' => esc_html__( 'Comment Title', 'bacola' ),
                'type' => Controls_Manager::TEXTAREA,
                'pleaceholder' => esc_html__( 'Enter the comment title.', 'bacola' ),
        ...
        $this->add_control( 'customer_comment',
            [
                'label' => esc_html__( 'Comment', 'bacola' ),
                'type' => Controls_Manager::TEXTAREA,
                'pleaceholder' => esc_html__( 'Enter desc here', 'bacola' ),
		...
		$this->add_control( 'title_hvrcolor',
           [
               'label' => esc_html__( 'Title Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'comment_title_color',
           [
               'label' => esc_html__( 'Comment Title Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'comment_title_hvrcolor',
           [
               'label' => esc_html__( 'Comment Title Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'comment_color',
           [
               'label' => esc_html__( 'Comment Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'comment_hvrcolor',
           [
               'label' => esc_html__( 'Comment Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'name_color',
           [
               'label' => esc_html__( 'Name Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'name_hvrcolor',
           [
               'label' => esc_html__( 'Name Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'position_color',
           [
               'label' => esc_html__( 'Position Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
		...
		$this->add_control( 'position_hvrcolor',
           [
               'label' => esc_html__( 'Position Hover Color', 'bacola' ),
               'type' => Controls_Manager::COLOR,
               'default' => '',
