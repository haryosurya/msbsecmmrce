	...
	<div class="before-shop-loop">
		...
		<?php if(get_theme_mod('bacola_grid_list_view','0') == '1'){ ?>
			...
			<?php if(bacola_shop_view() == 'list_view') { ?>
				...
				<a href="<?php echo esc_url(add_query_arg('shop_view','grid_view')); ?>" class="shop-view">
			...
			<?php } else { ?>
				...
				<a href="<?php echo esc_url(add_query_arg('shop_view','grid_view')); ?>" class="shop-view active">
					<i class="klbth-icon-4-grid"></i>
				</a>
			<?php } ?>
		<?php } ?>
