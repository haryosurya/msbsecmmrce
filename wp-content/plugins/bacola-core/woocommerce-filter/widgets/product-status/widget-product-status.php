...
class widget_product_status extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array('description' => esc_html__('For Product Archive Page.','bacola') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'product_status' );
		 parent::__construct( 'product_status', esc_html__('Bacola Product Status','bacola'), $widget_ops, $control_ops );
	}
