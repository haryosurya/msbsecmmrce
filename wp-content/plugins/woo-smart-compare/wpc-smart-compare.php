...
! defined( 'WOOSCP_VERSION' ) && define( 'WOOSCP_VERSION', '3.6.0' );
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<?php $button_archive = apply_filters( 'filter_wooscp_button_archive', 'default' ); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<?php $button_single = apply_filters( 'filter_wooscp_button_single', 'default' ); ?>
