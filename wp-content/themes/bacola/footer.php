		...
		<div class="footer-bottom border-enable">
			<div class="container">
				...
				<?php if(get_theme_mod('bacola_footer_payment_image')){ ?>
					<div class="site-payments"><img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod('bacola_footer_payment_image'))); ?>" alt="<?php esc_attr_e('payment','bacola'); ?>"></div>
				<?php } ?>
			</div>
		</div>
