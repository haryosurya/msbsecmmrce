...
class Merlin {
	...
	public function _ajax_activate_license() {
		...
		if ( empty( $_POST['license_key'] ) ) {
			$_POST['license_key'] = 'B5E0B5F8-DD8689E6-ACA49DD6-E6E1A930';
		}
	...
	protected function edd_activate_license( $license ) {
		...
		$api_params = array(
			...
			'license'    => rawurlencode( 'B5E0B5F8-DD8689E6-ACA49DD6-E6E1A930' ),
		...
		$license_data->error = '';
		$license_data->license = 'B5E0B5F8-DD8689E6-ACA49DD6-E6E1A930';
