<?php
require_once (get_template_directory() . '/includes/main.php'); 
...
if (wp_is_mobile() || $wooWhatsAppObject->getOption('woo_wa_button_show_desktop', 'yes') == 'yes') {
	...
	?>
	<div>
		<button class="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_class', $wooWhatsAppObject->default['']) ?>" id="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_id', 'woowhatsapp-button') ?>" style="<?php echo $wooWhatsAppObject->getOption('woo_wa_button_css') ?>" type="button" onclick="openWA()" target="_blank"><?php echo $button ?></button>
	</div>
	<script>
