...
// // Add WA Button after add to cart button end
	...
	/* custom class wasap */
   class yosu_WA_Checkout {

      protected $version = '0.0.1';
      // protected $wa_number = get_option('woo_wa_phone_number');
      protected $resend_text = 'Klik tombol ini apabila tidak dapat redirect secara langsung ke WhatsApp';
   ...
   EOT;
       ...
       public function enqueue_scripts() {
         $uri = get_template_directory_uri();
           wp_register_script( 'woo-whatsapp-checkout', $uri . '/yosu-wa.js', array( 'jquery' ), $this->version );
           wp_register_style( 'fontawesome', 'https://use.fontawesome.com/releases/v5.13.0/css/all.css' );   
           if( is_checkout() ) { 
               wp_enqueue_style( 'fontawesome' );
            wp_localize_script( 'woo-whatsapp-checkout', 'yosu', array(
               'ajaxurl' => admin_url( '/admin-ajax.php' ),
               'security' => wp_create_nonce( 'yosu-woo-checkout-wa' )
            ) );
      ...
      public function whatsapp_checkout() {
          check_ajax_referer( 'yosu-woo-checkout-wa', 'security' );
